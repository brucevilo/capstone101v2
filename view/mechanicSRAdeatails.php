					...
					<div class="row">
						<div class="col-sm-12 text-center">
							...
							<div class="center">
                                ...
                                include('../controller/getBySRAId.php'); ?>
								
                             
								<b>Sender Name :</b> <?php echo strtoupper($row['lastname']).", ".strtoupper ($row['firstname']) ?>
									<br/>
									<b>Contact No.</b> <?php echo strtoupper($row['contactno'])?>
									<br/>
									<b>Address :</b> <?php echo strtoupper($row['address'])?>
									<br/>
								Please Contact this motorist as soon as possible..
